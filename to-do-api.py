...
app.config['MYSQL_DATABASE_USER'] = 'insider'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Insider_1'
...
# Write a function named `home` which returns 'Welcome to the Rabia's To-Do API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Rabia's To-Do API Service"
